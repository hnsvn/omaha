...
const CString kExpectedHuhiUrlBegin = _T("https://support.huhisoft.com/");
const CString kExpectedHuhiUrlAfterOs = _T("");
...
TEST_F(HelpUrlBuilderTest, BuildGetHelpUrl_User) {
  ...
  EXPECT_STREQ(kExpectedHuhiUrlBegin, url.Left(kExpectedHuhiUrlBegin.GetLength()));
  EXPECT_NE(-1, url.Find(kExpectedHuhiUrlAfterOs))
