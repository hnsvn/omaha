...
const TCHAR kFullMachineOmahaMainKeyPath[] =
    _T("HKLM\\Software\\HuhiSoftware\\Update\\");
const TCHAR kFullUserOmahaMainKeyPath[] =
    _T("HKCU\\Software\\HuhiSoftware\\Update\\");
const TCHAR kFullMachineOmahaClientKeyPath[] =
    _T("HKLM\\Software\\HuhiSoftware\\Update\\Clients\\")
    _T("{B131C935-9BE6-41DA-9599-1F776BEB8019}");
const TCHAR kFullUserOmahaClientKeyPath[] =
    _T("HKCU\\Software\\HuhiSoftware\\Update\\Clients\\")
    _T("{B131C935-9BE6-41DA-9599-1F776BEB8019}");
...
const TCHAR kRegistryHiveOverrideRoot[] =
    _T("HKCU\\Software\\HuhiSoftware\\Update\\UnitTest\\");

const TCHAR kExpectedUrlForDummyAppAndNoOmahaValues[] = _T("https://updates.huhisoft.com/service/check2&appid=%7B8E472B0D-3E8B-43b1-B89A-E8506AAF1F16%7D&appversion=3.4.5.6&applang=en-us&machine=1&version=0.0.0.0&userid=&osversion=");  // NOLINT
...
TEST_P(GoogleUpdateRecoveryRegistryProtectedTest,
  ...
  const TCHAR kExpectedUrlFormat[] = _T("https://updates.huhisoft.com/service/check2&appid=%%7B8E472B0D-3E8B-43b1-B89A-E8506AAF1F16%%7D&appversion=3.4.5.6&applang=en-us&machine=1&version=5.6.78.1&userid=%s&osversion=");  // NOLINT
...
TEST_P(GoogleUpdateRecoveryRegistryProtectedTest,
  ...
  const TCHAR kExpectedUrlFormat[] = _T("https://updates.huhisoft.com/service/check2&appid=%%7B8E472B0D-3E8B-43b1-B89A-E8506AAF1F16%%7D&appversion=3.4.5.6&applang=en-us&machine=0&version=5.6.78.1&userid=%s&osversion=");  // NOLINT
...
TEST_P(GoogleUpdateRecoveryRegistryProtectedTest,
  ...
  const TCHAR kExpectedUrl[] = _T("https://updates.huhisoft.com/service/check2&appid=&appversion=&applang=&machine=1&version=0.0.0.0&userid=&osversion=");  // NOLINT
