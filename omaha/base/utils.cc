...
const TCHAR* const kGoopdateBoundaryDescriptor = _T("HuhiUpdate_BD");
const TCHAR* const kGoopdatePrivateNamespace = _T("HuhiUpdate");
const TCHAR* const kGoopdatePrivateNamespacePrefix = _T("HuhiUpdate\\");
