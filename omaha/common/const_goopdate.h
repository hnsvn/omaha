...
const TCHAR* const kRegValueServiceName           = _T("huhi_service_name");
const TCHAR* const kRegValueMediumServiceName     = _T("huhim_service_name");
const TCHAR* const kRegValueTaskNameC             = _T("huhi_task_name_c");
const TCHAR* const kRegValueTaskNameUA            = _T("huhi_task_name_ua");
...
const TCHAR* const kServicePrefix               = _T("huhi");
const TCHAR* const kMediumServicePrefix         = _T("huhim");
